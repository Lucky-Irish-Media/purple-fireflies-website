...
import type { LegalObserverRequest } from "@/app/lib/definitions";
import { formatDate, formatDateTime, formatPhone } from "@/app/admin/lib/utils";
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-4">
        ...
        />
        <span className="text-sm text-text-secondary">{data.length} request{data.length !== 1 ? "s" : ""}</span>
      </div>
